              ...
              createVNode("div", { class: "max-w-[90%] md:max-w-[50%] mx-auto" }, [
                ...
                createVNode("form", {
                  ...
                  createVNode("div", { class: "w-100 text-end" }, [
                    createVNode("button", { class: "rounded-lg bg-blue-600 hover:bg-blue-700 text-white py-3 px-4" }, " Update Blog ")
                  ])
                ], 40, ["onSubmit"])
              ])
            ];
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Blog/Edit.vue");
