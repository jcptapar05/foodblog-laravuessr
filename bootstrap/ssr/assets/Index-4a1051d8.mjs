    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>Filipino Kitchen: Authentic Recipes &amp; Culinary Adventures</title><meta head-key="description" name="description" content="Experience the Best of the Philippines with our Recipes and Travel Guide. Discover Authentic Filipino Cuisine and Amazing Travel Destinations."${_scopeId}>`);
          } else {
            return [
              createVNode("title", null, "Filipino Kitchen: Authentic Recipes & Culinary Adventures"),
              createVNode("meta", {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-4"${_scopeId}><div class="text-center"${_scopeId}><h1 class="mb-32 font-black text-7xl"${_scopeId}>Filipino Foods recipes</h1></div><div${_scopeId}><input${ssrRenderAttr("value", unref(search))} type="text" class="rounded-3xl ps-6" placeholder="Search..."${_scopeId}></div>`);
            ...
            return [
              createVNode("div", { class: "px-4" }, [
                createVNode("div", { class: "text-center" }, [
                  createVNode("h1", { class: "mb-32 font-black text-7xl" }, "Filipino Foods recipes")
                ]),
