  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.blogs, (blog) => {
        _push(`<tr><td class="py-2 border">${ssrInterpolate(blog.name)}</td><td class="py-2 border"><img${ssrRenderAttr("src", `/storage/${blog.image}`)} class="h-16 mx-auto"${ssrRenderAttr("alt", blog.name)}></td><td class="py-2 border text-center"><a${ssrRenderAttr("href", blog.video)} target="_blank" class="turncate-1 mx-auto text-blue-400">${ssrInterpolate(blog.video)}</a></td><td class="py-2 border">`);
